...
import { type IFileDialogWebComponentProps, FileDialogWebComponent } from './components/FileDialog';
...
export default class SubscriptionWebComponent extends HTMLElement {
    ...
    connectedCallback(): void {
        const props = this.getPropsFromAttributes<IFileDialogWebComponentProps>();
